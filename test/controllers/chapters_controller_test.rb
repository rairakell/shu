...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { content: @chapter.content, fiction_id: @chapter.fiction_id, name: @chapter.name }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { content: @chapter.content, fiction_id: @chapter.fiction_id, name: @chapter.name }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
